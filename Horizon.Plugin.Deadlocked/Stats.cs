...
namespace Horizon.Plugin.Deadlocked
{
    ...
    public enum CustomPlayerStatIds : int
    {
        ...
        CUSTOM_STAT_SURVIVAL_MAP1_HIGH_SCORE = 177,
        CUSTOM_STAT_SURVIVAL_MAP2_HIGH_SCORE = 178,
        CUSTOM_STAT_SURVIVAL_MAP3_HIGH_SCORE = 179,
        CUSTOM_STAT_SURVIVAL_MAP4_HIGH_SCORE = 180,
        CUSTOM_STAT_SURVIVAL_MAP5_HIGH_SCORE = 181,
        ...
        CUSTOM_STAT_SURVIVAL_ORXON_XP = 190,
        CUSTOM_STAT_SURVIVAL_MPASS_XP = 196,
